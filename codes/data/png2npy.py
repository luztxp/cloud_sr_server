...
parser.add_argument('--pathFrom', default='../../datasets/train_data/lr_img/x2/',
                    help='directory of images to convert')
parser.add_argument('--pathTo', default='../../datasets/train_data/lr_npy/x2/',
    ...
    if len(dirs) == 0:
        ...
        for fileName in files:
            ...
            if ext == '.png' or ext == '.jpg' :
                print('Processing %s' % os.path.join(path, fileName))
